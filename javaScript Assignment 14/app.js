...
var phoneManufaturers = ["Apple" , "Samsung" , "Motorola" , "Nokia" , "Sony" , "Haier" ]
document.write("<select id = phoneSelect>");
document.write(`<option value = apple >${phoneManufaturers[0]}</option>`);
document.write(`<option value = samsung >${phoneManufaturers[1]}</option>`);
document.write(`<option value = motorola >${phoneManufaturers[2]}</option>`);
document.write(`<option value = nokia >${phoneManufaturers[3]}</option>`);
document.write(`<option value = sony >${phoneManufaturers[4]}</option>`);
document.write(`<option value = Haier >${phoneManufaturers[5]}</option>`);
